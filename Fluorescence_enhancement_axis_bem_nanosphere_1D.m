...
directory = pwd;
ndir = ['D',num2str(diameter),'_AgNS_distance_dependent_decayrates','_Exc',num2str(enei_field),'_Dip',num2str(enei_dipole)];
mkdir(ndir)
cd(ndir)
%% Calculate and save the scattering spectrum for reference
[ sca, fit, Lorentz ] = spect_GNS_BEM( epstab, diameter, linspace(400,700,20 ));
